...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val centerLat = -6.4653872
    private val centerLng = 106.7881365
    private val geofenceRadius = 250.0
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val villaCitayam = LatLng(centerLat, centerLng)
        mMap.addMarker(MarkerOptions().position(villaCitayam).title("Villa Citayam"))
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(villaCitayam, 15f))
        mMap.addCircle(
            CircleOptions()
                .center(villaCitayam)
